            ...
            >
              {[
                ...
                <motion.div 
                  ...
                  className="bg-white dark:bg-gray-900 border border-amber-200 dark:border-amber-900/20 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow"
                >
        ...
        <section className="py-16 px-4">
          <div className="container max-w-screen-xl mx-auto">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold mb-4 text-amber-900 dark:text-amber-300">Meet Our Team</h2>
              <p className="text-xl max-w-3xl mx-auto text-gray-700 dark:text-gray-300">
            ...
            >
              {teamMembers.map((member, index) => (
                <motion.div 
                  key={index}
                  variants={itemVariants}
                  className="bg-white dark:bg-gray-900 border border-amber-200 dark:border-amber-900/20 rounded-xl overflow-hidden"
                >
                  <div className="aspect-square overflow-hidden bg-amber-100 dark:bg-amber-900/20">
                    <img 
                      src={member.image} 
                      alt={member.name} 
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-amber-900 dark:text-amber-300">{member.name}</h3>
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-amber-500 to-amber-700 dark:from-amber-900 dark:to-amber-800 text-white">
          <div className="container max-w-screen-xl mx-auto text-center">
            ...
            >
              ...
              <motion.a
                href="/auth"
                className="inline-block py-3 px-8 bg-white text-amber-800 font-medium rounded-lg shadow-lg hover:shadow-xl transition-all hover:bg-amber-50"
