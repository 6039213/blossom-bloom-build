            ...
            >
              <div className="flex flex-1">
                ...
                <SidebarInset className="flex-1 transition-all duration-300">
                  <div className="flex items-center p-4 bg-gradient-to-r from-amber-50 to-amber-100 dark:from-zinc-900 dark:to-zinc-800 border-b border-amber-200 dark:border-zinc-700">
                    <SidebarTrigger>
                      <motion.div 
                        whileHover={{ rotate: 20, scale: 1.1 }}
                        transition={{ type: 'spring', stiffness: 300 }}
                        className="p-2 rounded-md hover:bg-amber-200/50 dark:hover:bg-zinc-700 cursor-pointer"
                      >
      ...
      <AnimatePresence mode="wait">
        {state === "expanded" && (
          <motion.div
            ...
            className="h-full bg-gradient-to-b from-amber-50 to-amber-100 dark:from-zinc-900 dark:to-zinc-800"
          >
            <div className="flex justify-between p-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="p-1 rounded-md hover:bg-amber-200/50 dark:hover:bg-zinc-700"
              >
                  ...
                  <motion.div
                    ...
                    className={`flex items-center gap-3 px-3 py-2 rounded-md transition-colors mb-1 cursor-pointer ${
                      isActivePath(link.path) 
                        ...
                        : "hover:bg-amber-200/30 dark:hover:bg-zinc-700/70 text-amber-700 dark:text-amber-400 hover:text-amber-900 dark:hover:text-amber-200"
                    }`}
